const API_URL = "https://areer-center-1-otsx3wt00-mishafedorov1705-3282s-projects.vercel.app/"; //https://Workspace-methed.vercel.app/
  ...
  logo,
        ...
        <article class="detail">
          ...
          <p class="detail__resume">
            ...
            <a class="green-text" href="mailto: ${email}"
              >${email}</a
            >
          </p>
        </article>
